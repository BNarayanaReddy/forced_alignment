...
def align_with_top_models(
    corpus_dir: str, oov_summary_file: str, output_dir: str, lang: str, top_k: int = 3
):
    ...
    for dictionary in top_dictionaries:
        ...
        alignment_output_dir = os.path.join(
            output_dir, f"{dictionary}_aligned"
        )  # save alignments to {dictionary}_aligned folder
...
if __name__ == "__main__":
    ...
    align_with_top_models(
        args.corpus_dir, args.oov_summary_file, args.output_dir, args.lang, args.top_k
    )
